...
<div class="table-wrapper">
    <table class="fl-table">
        ...
        <tr>
          ...
          <td><div class="button"><a href="./edit/book/editbook.php?id=<?php echo $row['id']; ?>"> Update </a></div></td>
          <td><div class="button"><a href="./edit/book/deletebook.php?id=<?php echo $row['id']; ?>"> Delete </a></div></td>
        </tr>

...
<div class="table-wrapper">
    <table class="fl-table">
        ...
        <tr>
          ...
          <td><div class="button"><a href="./edit/lonch/editlon.php?id=<?php echo $row['launch_ticket_id']; ?>"> EDIT </a></div></td>
          <td><div class="button"><a href="./edit/lonch/deletelon.php?id=<?php echo $row['launch_ticket_id']; ?>"> Delete </a></div></td>
        </tr>

...
<div class="table-wrapper">
    <table class="fl-table">
        ...
        <tr>
          ...
          <td><div class="button"><a href="./edit/merpay/editmerpay.php?id=<?php echo $row['merid']; ?>"> Update </a></div></td>
          <td><a href="./payment.php"><button class="button" type="button">Pay</button></a></td>
          <td><div class="button"><a href="./edit/merpay/deletemerpay.php?id=<?php echo $row['merid']; ?>"> Delete </a></div></td>
        </tr>

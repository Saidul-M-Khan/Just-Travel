...
<body>
  ...
  <section class="home-section">
      <div class="text">User Order List</div>
<!-- after head -->
<!-- serach box -->
<div>
...
<div class="table-wrapper">
    <table class="fl-table">
        ...
        <tr>
          ...
          <td><div class="button"><a href="./edit/upay/editupay.php?id=<?php echo $row['id']; ?>"> EDIT </a></div></td>
          <td><div class="button"><a href="./edit/upay/deleteupay.php?id=<?php echo $row['id']; ?>"> Delete </a></div></td>
        </tr>

      ...
      <table class="fl-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><div class="button"><a href="./edit/offer/editoffer.php?id=<?php echo $row['offer_id']; ?>"> EDIT </a></div></td>
            <td><div class="button"><a href="./edit/offer/deleteoffer.php?id=<?php echo $row['offer_id']; ?>"> Delete </a></div></td>
          </tr>

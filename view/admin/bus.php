...
<div class="table-wrapper">
    <table class="fl-table">
        ...
        <tr>
          ...
          <td><div class="button"><a href="./edit/bus/editbus.php?id=<?php echo $row['bus_ticket_id']; ?>"> EDIT </a></div></td>
          <td><div class="button"><a href="./edit/bus/deletebus.php?id=<?php echo $row['bus_ticket_id']; ?>"> Delete </a></div></td>
        </tr>

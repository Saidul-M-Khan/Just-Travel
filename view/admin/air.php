...
<div class="table-wrapper">
    <table class="fl-table">
        ...
        <tr>
          ...
          <td><div class="button"><a href="./edit/air/editair.php?id=<?php echo $row['air_ticket_id']; ?>"> EDIT </a></div></td>
          <td><div class="button"><a href="./edit/air/deleteair.php?id=<?php echo $row['air_ticket_id']; ?>"> Delete </a></div></td>
        </tr>

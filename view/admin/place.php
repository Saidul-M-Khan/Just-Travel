      ...
      <table class="fl-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><div class="button"><a href="./edit/place/editplace.php?id=<?php echo $row['place_id']; ?>"> EDIT </a></div></td>
            <td><div class="button"><a href="./edit/place/deleteplace.php?id=<?php echo $row['place_id']; ?>"> Delete </a></div></td>
          </tr>
